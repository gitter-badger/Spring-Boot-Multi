...
public final class DateUtil {
    ...
    public static Date parseDateToYYYY(Date date) {
        String yyyy = format(date, "yyyy");
        return parseDate(yyyy, "yyyy");
    }
     ...
     * @return
     *
     * String format = format(date, "yyyy-MM-dd");//今天日期0时开始
     *         Date date1 = parseDate(format, "yyyy-MM-dd");
     *
     *                 String format = DateUtil.format(DateUtil.getDate(new Date(), 1), "yyyy-MM-dd");//明天日期0时开始
     *         Date date1 = DateUtil.parseDate(format, "yyyy-MM-dd");
     */
     ...
     * @return
     */
    public static String TimestampTenNumberConventToString(int date, String formatString) {
        String detaultFormat = "yyyy年MM月dd日 hh:mm:ss SSS a";
        if (formatString != null) {
            detaultFormat = formatString;
        }
        long millisecond = Long.parseLong(String.valueOf(date) + "000");
        Date date11 = new Date(millisecond);
        SimpleDateFormat format = new SimpleDateFormat(detaultFormat);
        return format.format(date11);
    }

    public static void main(String[] rags) {
        System.out.println(TimestampTenNumberConventToString(1528214400,null));
        System.out.println(TimestampTenNumberConventToString(1528128000,null));
    }
}
